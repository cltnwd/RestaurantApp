...
public class ManagerCheck extends AppCompatActivity
{
    ...
    public void loginManager(View view)
    {
        ...
        {
            new ManagerCheckAsync(this, usernameET.getText().toString(), passwordET.getText().toString()).execute();
        }
    }
    ...
    void parseData(String jsonstring)
    {
        ...
        try
        {
            ...
            if (root.optInt("success") == 1)
            {
                ...
                // go back to main
                Intent intent = new Intent(this,RegisterKitchen.class);
