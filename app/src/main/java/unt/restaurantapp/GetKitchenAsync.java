 ...
 */
public class GetKitchenAsync extends AsyncTask<Pair<Context, String>, Void, String>
{
    StaticIP ip = new StaticIP();
    private String urlstring = "http://" + ip.getIP() + "/webservice/viewKitchen.php";
    URL url;
    ViewUsers caller;

    GetKitchenAsync(ViewUsers context)
    {
        caller = context;
    }
