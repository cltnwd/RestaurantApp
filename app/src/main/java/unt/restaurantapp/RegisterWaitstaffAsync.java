 ...
 */
public class RegisterWaitstaffAsync extends AsyncTask<Pair<Context, String>, Void, String>
{
    ...
    private String urlstring = "http://" + ip.getIP() + "/webservice/registerWaitstaff.php";
    URL url;
    RegisterWaitstaff caller;

    RegisterWaitstaffAsync(RegisterWaitstaff context, String fname, String lname, String username, String email, String password)
    {
        caller = context;
        this.fname = fname;
        this.lname = lname;
    ...
    protected void onPostExecute(String result) {
        caller.waiterRegistered(result);
    }
