 ...
 */
class LoginUserAsync extends AsyncTask<Pair<Context, String>, Void, String> {
    String fname, lname, username, email, password;

    private String urlstring = "http://10.0.3.2/webservice/login.php";
    URL url;
    LoginActivity caller;

    LoginUserAsync(LoginActivity context,String username, String password) {
        caller = context;
