 ...
 */
public class KitchenLoginAsync extends AsyncTask<Pair<Context, String>, Void, String>
{
    String fname, lname, username, email, password;

    StaticIP ip = new StaticIP();
    private String urlstring = "http://"+ ip.getIP() + "/webservice/kitchenLogin.php";
    URL url;
    KitchenLogin caller;

    KitchenLoginAsync(KitchenLogin context, String username, String password)
    {
        caller = context;
