 ...
 */
public class ManagerCheckAsync extends AsyncTask<Pair<Context, String>, Void, String>
{
    ...
    ManagerCheckAsync(ManagerCheck context, String username, String password)
    {
        caller = context;
