 ...
 */
public class RegisterKitchenAsync extends AsyncTask<Pair<Context, String>, Void, String>
{
    ...
    private String urlstring = "http://" + ip.getIP() + "/webservice/registerKitchen.php";
    URL url;
    RegisterKitchen caller;

    RegisterKitchenAsync(RegisterKitchen context, String fname, String lname, String username, String email, String password)
    {
        caller = context;
        this.fname = fname;
        this.lname = lname;
