 ...
 */
public class GetManagersAsync extends AsyncTask<Pair<Context, String>, Void, String>
{
    StaticIP ip = new StaticIP();
    private String urlstring = "http://" + ip.getIP() + "/webservice/viewManagers.php";
    URL url;
    ViewUsers caller;

    GetManagersAsync(ViewUsers context)
    {
        caller = context;
    }
