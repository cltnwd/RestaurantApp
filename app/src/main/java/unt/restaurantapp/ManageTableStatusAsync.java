 ...
 */
class ManageTableStatusAsync extends AsyncTask<Pair<Context, String>, Void, String> {
    ...
    URL url;
    ManageTablesActivity caller;

    ManageTableStatusAsync(ManageTablesActivity context) {
        caller = context;
    }
