 ...
 */
public class ManagerVerifactionAsync extends AsyncTask<Pair<Context, String>, Void, String>
{
    ...
    URL url;
    ManagerVerifiction caller;

    ManagerVerifactionAsync(ManagerVerifiction context, String username, String password)
    {
        caller = context;
